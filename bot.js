...
client.on('guildCreate', async guild => {
  const girismesaj = [
    'Gizemli Bot sunucunuza eklendi.',
    'Bu bot **Kral Takipte#7306** tarafından geliştirilmektedir.',
    '-yardım',
    '-botbilgi',
    '-ping',
    '-davet ',
...
client.on("ready", async message => {
  var Activity = [
      ...
      ` ${client.guilds.size.toLocaleString()}  Sunucu İçin | Teşekürler..`,
    
      ` ${client.guilds.reduce((a, b) => a + b.memberCount, 0).toLocaleString()} Kulanıcı İçin | Teşekürler..`,
