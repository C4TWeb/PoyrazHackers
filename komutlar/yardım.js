...
exports.run = (client, message, args) => {
  ...
  let pages = [
              ...
              '**Nsfw  **\n\n\n ' + '/hd = +18 resimler atar.',
              '**Yapımcım **\n\n\n ' + 'Yapımcım : DarkTower \nSağlayıcım : DarkTower Project',
              ];
  let page = 1;

  const embed = new Discord.RichEmbed()
    .setColor('#00b7eb')
    .setThumbnail('https://cdn.discordapp.com/avatars/623485508009459724/fb9c43f733f07267510db707d325e3b6.png?size=128')
